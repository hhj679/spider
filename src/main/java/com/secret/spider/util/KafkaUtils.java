...
public class KafkaUtils {
	static Logger logger = Logger.getLogger(KafkaUtils.class);
	...
	public static Properties initConsumerProps(String group, String autoCommit, String pollRecords) {
		Properties props = new Properties();
        ...
        //poll的数量限制,爬取数据一次拿出一个message即可，避免拿出后爬取失败
