...
public class ConsumerReviewHomeRequest {
	static Logger logger = Logger.getLogger(ConsumerReviewHomeRequest.class);
	
	public static void main(String[] args) {
		// TODO Auto-generated method stub
		request("zol-product-review-request-group", "zol-product-review-request-topic");
	}
